...
<div id="pxs_container" class="pxs_container"> 
 ...
 <figure> <img src="images/buro.png"  alt="" align="left" /></figure >
 <font size="3" color="red" face="Times new roman" font>
 <div class="top-cc">  <a><img src="images/cart.png" align="left"/>Заберите его самостоятельно</a>
</div>
<div class="top-lc">  <a><img src="images/speak.png"    align="left" />При оформлении заказа
назовите промокод «BURO»</a>
</div>
<div class="top-rc">  <a><img src="images/bonus.png"  width="40" height="40" align="left"   />Получите скидку</a>
</div>
 </font>
       ...
       <div class="menu_bot">
        ...
        <ul class="pxs_thumbnails navigatable" style="position: absolute; left: 288px; display: block;">
          ...
          <li >    <font size="5" color="red" face="Segoe Script" font>
            <a href="basket.php"  class="selected act">Корзина</a><div style="opacity: 0; left: -21px; bottom: 55px; display: none;"><img src="images/space.gif" alt="Second Image"></div>
              </font>
            <div>
             <ul>
               <li class="first"><p></p></li>
               <li><form action="basket.php"><input type="submit" value="Ваша корзина" /></li>
                             </ul>
             <i></i>
            </div>
    </div>

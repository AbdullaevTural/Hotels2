              ...
              <div class="article">  
                ...
                <div class="scroll-wrap">
                  <div class="scroll-pane">   
                    ...
                    <p><em><b><FONT COLOR="Green" FACE="italic" SIZE="6">Virtual reality </em></b></FONT></p>
     <hr>
            <p><strong></p>
            <p><strong></p>
...
<?
$prodact1 = get_prodact1();
foreach ($prodact1 as $item2):?>
<table align ="center" cellpadding ="0" cellspacing ="0" borden ="0">
<tr>
<td valign ="top">
<div><a href ="#"> <img src="images/<?=$item2 ['image']?>" width="130" height="111" alt =""/></a></div>
<div>
<div><a href ="<?=$item2 ['page']?>"><? echo ($item2 ['title'])?></a></div>
<div><?echo ($item2 ['price'].P)?></div>
</div>
</td>
</tr>
</table>

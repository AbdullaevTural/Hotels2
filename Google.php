              ...
              <div class="article">  
                ...
                <div class="scroll-wrap">
                  <div class="scroll-pane">   
                    ...
                    <p><em><b><FONT COLOR="Green" FACE="italic" SIZE="6">Google Glass 3.0	 </em></b></FONT></p>
     <hr>
            <p><strong></p>
            <p><strong></p>
...
<tr>
 ...
 <td> 
    <?
    $query = "SELECT * from prodact where id=2";
...
<ul>
<li>Характеристики экрана: проекционный, «эквивалент 25-дюймового дисплея с расстояния 2,4 метра»&nbsp;</li>
<li>Разрешение камеры: 5 Мп, видео 720p</li>
<li>Встроенный процессор: TI OMAP 4430 (ARM Cortex-A9), два ядра, 1,01 ГГц</li>
<li>Встроенная память: 16 ГБ (доступно 12 Гб)</li>
<li>Встроенная оперативная память: 2 ГБ</li>
<li>Беспроводные соединения: Wi-Fi, Bluetooth 4.0</li>
<li>Интерфейс: microUSB</li>
<li>Операционная система: Android 4.0.4 with Glass Software</li>
<li>Встроенные датчики: акселерометр, гироскоп</li>
</ul>
           </tr>

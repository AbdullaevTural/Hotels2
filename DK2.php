              ...
              <div class="article">  
                ...
                <div class="scroll-wrap">
                  <div class="scroll-pane">   
                    ...
                    <p><em><b><FONT COLOR="Green" FACE="italic" SIZE="6">Шлем виртуальной реальности Oculus Rift DK2	 </em></b></FONT></p>
     <hr>
            <p><strong></p>
            <p><strong></p>
...
<tr>
 ...
 <td> 
    <?
    $query = "SELECT * from prodact where id=4";
    ...
    ?></td>
		   ...
		   <div class="features_advanced" style="border-top:none; border-right:1px solid #ddd; border-left:1px solid #ddd; padding: 0;  box-sizing: border-box;">
		<div style="display: table; width: 100%;"><div style="display: table-cell; width: 20%; border-top:1px solid #ddd; border-right:1px solid #ddd; vertical-align: middle; text-align: center; background-color:#FAFAFA;">Технические характеристики</div><div style="display:flex; align-items: center; min-height: 40px; border-top:1px solid #ddd;"><div style="width: 65%; padding: 10px 0 10px 20px; float: left;">Разрешение</div><div style="width: 55%; padding: 10px 20px 10px 20px; float: left;">1920x1080</div><div class="clearfix"></div></div><div style="display:flex; align-items: center; min-height: 40px; border-top:1px solid #ddd;"><div style="width: 65%; padding: 10px 0 10px 20px; float: left;">Угол обзора</div><div style="width: 55%; padding: 10px 20px 10px 20px; float: left;">100°</div><div class="clearfix"></div></div><div style="display:flex; align-items: center; min-height: 40px; border-top:1px solid #ddd;"><div style="width: 65%; padding: 10px 0 10px 20px; float: left;">Сенсоры</div><div style="width: 55%; padding: 10px 20px 10px 20px; float: left;">3D-акселерометр, гироскоп, магнитометр.</div><div class="clearfix"></div></div><div style="display:flex; align-items: center; min-height: 40px; border-top:1px solid #ddd;"><div style="width: 65%; padding: 10px 0 10px 20px; float: left;">Вес</div><div style="width: 55%; padding: 10px 20px 10px 20px; float: left;">440 г</div><div class="clearfix"></div></div><div style="display:flex; align-items: center; min-height: 40px; border-top:1px solid #ddd;"><div style="width: 65%; padding: 10px 0 10px 20px; float: left;">Производство</div><div style="width: 55%; padding: 10px 20px 10px 20px; float: left;">Китай</div><div class="clearfix"></div></div><div style="display:flex; align-items: center; min-height: 40px; border-top:1px solid #ddd;"><div style="width: 65%; padding: 10px 0 10px 20px; float: left;">Разработчик</div><div style="width: 55%; padding: 10px 20px 10px 20px; float: left;">США</div><div class="clearfix"></div></div><div style="display:flex; align-items: center; min-height: 40px; border-top:1px solid #ddd;"><div style="width: 65%; padding: 10px 0 10px 20px; float: left;">Комплектаци?</div><div style="width: 55%; padding: 10px 20px 10px 20px; float: left;">Шлем, 2 комплекта линз с разной фокусировкой, ткань дл? чистки линз, трекинг-камера, USB-кабель, кабель синхронизации дл? подключени? камеры, переходник DVI-HDMI, блок питани? дл? дополнительного USB на шлеме, инструкци?.</div><div class="clearfix"></div></div></div>	</div>
           </tr>

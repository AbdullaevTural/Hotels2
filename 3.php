...
<?
$prodact3 = get_prodact3();
foreach ($prodact3 as $item1):?>
<table align ="center" cellpadding ="0" cellspacing ="0" borden ="0">
<tr>
<td valign ="top">
<div><a href ="#"> <img src="images/<?=$item1 ['image']?>" width="130" height="111" alt =""/></a></div>
<div>
<div><a href ="<?=$item1 ['page']?>"><? echo ($item1 ['title'])?></a></div>
<div><?echo ($item1 ['price'].P)?></div>
</div>
</td>
</tr>
</table>
